...
<div class="row">
	...
	<?php validate_staff_login(); ?>
								
		</div>
	</div>
				<form action="#" method="post" class="contact100-form p-t-5 w-full" >
					<div class="wrap-input100  m-lr-auto-lg ">
						<input class="s2-txt1 placeholder0 input100 trans-04" type="text" name="staff" placeholder="Emp ID.">
</div>&nbsp;&nbsp;&nbsp;&nbsp;
						<div class="wrap-input100  m-lr-auto-lg">
...
<div style="color: white; display: inline" class=" m-lr-auto-lg flex-l">
         	<p>Paradise Model School © <?php echo date("Y");?>.  Proudly Developed By: <a href="#" style="color: white;">  Greatness Abolade.</a> 
